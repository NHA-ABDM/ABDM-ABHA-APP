...
/// See also:
///
///  * [CustomDropdownButtonFormField2], which integrates with the [Form] widget.
...
///    integration.
class CustomDropdownButtonFormField2<T> extends FormField<T> {
  ...
  CustomDropdownButtonFormField2({
    ...
    InputDecoration? inputDecoration,
        ...
        super(
          ...
          builder: (FormFieldState<T> field) {
            ...
            //final InputDecoration decorationArg = InputDecoration(focusColor: focusColor);
                ...
                builder: (BuildContext context, StateSetter setState) {
                  return Column(
                    ...
                    children: [
                      ...
                      //   text: title ?? '',
                      //   style: titleStyle ??
                      //       InputFieldStyleDesktop.labelTextStyle,
                      //   children: <TextSpan>[
                      //     if (isRequired)
                      //       TextSpan(
                      //         text: ' *',
                      ...
                      InputDecorator(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton2._formField(
                            ...
                            onChanged:
                                onChanged == null ? null : state.didChange,
...
class _DropdownButtonFormFieldState<T> extends FormFieldState<T> {
  ...
  void didChange(T? value) {
    ...
    final CustomDropdownButtonFormField2<T> dropdownButtonFormField =
        widget as CustomDropdownButtonFormField2<T>;
    assert(dropdownButtonFormField.onChanged != null);
    dropdownButtonFormField.onChanged!(value);
  }

  @override
  void didUpdateWidget(CustomDropdownButtonFormField2<T> oldWidget) {
    super.didUpdateWidget(oldWidget);
