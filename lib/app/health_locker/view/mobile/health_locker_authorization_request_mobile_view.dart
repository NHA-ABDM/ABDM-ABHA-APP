...
class HealthLockerAuthorizationRequestMobileView extends StatefulWidget {
  final Map arguments;
  final VoidCallback submitRevokedRequestOnClick;

  const HealthLockerAuthorizationRequestMobileView({
  ...
  @override
  HealthLockerAuthorizationRequestMobileViewState createState() =>
      HealthLockerAuthorizationRequestMobileViewState();
}

class HealthLockerAuthorizationRequestMobileViewState
    extends State<HealthLockerAuthorizationRequestMobileView> {
